...
@Configuration
@EnableRabbit
public class KotikMessageConfig implements RabbitListenerConfigurer {
    ...
    @Bean
    public Queue kotikiAllQueue(){
        return new Queue(KOTIKI_ALL.getQueueName());
    }

    @Bean
    public Queue kotikiDeleteQueue(){
        return new Queue(KOTIK_DELETE.getQueueName());
    }

    @Bean
    public Queue kotikEditQueue() {
        return new Queue(KOTIK_EDIT.getQueueName());
    }
    ...
    @Bean
    public KotikMessageHandler eventResultHandler() {
        return new KotikMessageHandler();
    }
